...
import { createEvent, updateEvent, deleteEvent } from "../api/admin/event.api";
...
interface UseEventsReturn {
  ...
  // Admin-only actions (see admin/event.api.ts) - the backend already
  // supports these; EventsTable.tsx was calling them on this hook without
  // them ever being implemented here.
