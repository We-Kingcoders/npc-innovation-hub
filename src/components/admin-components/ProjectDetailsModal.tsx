    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fadeIn">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
        ...
        <div className="p-8 overflow-y-auto max-h-[calc(90vh-256px)]">
          ...
          {/* Owner Info */}
          <div className="flex items-center gap-4 mb-6 p-4 bg-mist-100 rounded-lg">
            <img
            ...
            />
            <div>
              <p className="font-semibold text-navy-800">{project.owner}</p>
              <p className="text-sm text-mist-600">{project.ownerRole}</p>
            </div>
          </div>
          ...
          <div className="space-y-3 mb-6">
            <a
              ...
              className="flex items-center gap-3 p-3 bg-navy-800 text-white rounded-lg hover:bg-navy-700 transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-3 p-3 bg-navy-700 text-white rounded-lg hover:bg-navy-800 transition-colors"
            >
              <svg
                className="w-5 h-5"
                fill="none"
