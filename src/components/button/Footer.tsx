      ...
      <div className="w-full pt-24 pb-12 relative min-h-[500px]" style={{backgroundColor: '#002B56'}}>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto  -mt-44 mb-20 relative z-10">
            <div className="flex flex-col md:flex-row overflow-hidden rounded-lg shadow-lg bg-green-200" style={{border: '1px solid #002B56'}}>
              ...
              <div className="md:w-1/2 p-6 flex flex-col justify-center">
                ...
                <div>
                  <button className="bg-white text-blue-900 px-6 py-2 rounded-full hover:bg-gray-100 transition">
                    Hire Us
                  </button>
                </div>
              </div>
          ...
          <div className="pt-4 border-t border-blue-800 text-white flex flex-col md:flex-row justify-between items-center text-sm">
            <a href="#" className="mb-2 md:mb-0">Privacy</a>
            <div className="mb-2 md:mb-0">© Copyright 2025</div>
