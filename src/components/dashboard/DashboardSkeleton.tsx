...
const Shimmer: React.FC<{ className?: string }> = ({ className = "" }) => (
  <div className={`bg-mist-300 rounded-lg animate-pulse ${className}`} />
);

const CardSkeleton: React.FC<{ className?: string }> = ({ className = "" }) => (
  <div
    className={`bg-white rounded-xl shadow-sm border border-mist-300 p-5 ${className}`}
  >
...
const DashboardSkeleton: React.FC = () => (
  <div className="min-h-screen bg-mist-100 p-6 animate-pulse">
    {/* Header */}
    <div className="mb-7">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
      {[1, 2, 3].map((n) => (
        <div
          key={n}
          className="bg-white rounded-xl shadow-sm border border-mist-300 p-5"
        >
