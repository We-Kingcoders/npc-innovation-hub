...
export async function fetchDashboardStats(): Promise<DashboardStat[]> {
  ...
  const userPromise = fetch(
    "https://npc-innovation-hub-bn.onrender.com/api/users/users",
    { headers },
  ).then(async (res) => {
  ...
  const projectPromise = fetch(
    "https://npc-innovation-hub-bn.onrender.com/api/projects",
    { headers },
  ).then(async (res) => {
  ...
  const resourcePromise = fetch(
    "https://npc-innovation-hub-bn.onrender.com/api/resources",
    { headers },
  ).then(async (res) => {
  ...
  const blogPromise = fetch(
    "https://npc-innovation-hub-bn.onrender.com/api/blogs",
    { headers },
  ).then(async (res) => {
  ...
  const taskPromise = fetch(
    "https://npc-innovation-hub-bn.onrender.com/tasks",
    { headers },
  ).then(async (res) => {
